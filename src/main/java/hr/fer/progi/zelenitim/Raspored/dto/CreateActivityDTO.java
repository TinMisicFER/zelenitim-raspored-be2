...
public class CreateActivityDTO {
	...
	public CreateActivityDTO(String descriptionOfActivity, double pricePerHour) {
	...
	public Activity createActivityFromCreateActivityDTO() {
		return new Activity(descriptionOfActivity, pricePerHour);
	}
